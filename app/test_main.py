...
def test_check_password_valid(valid_password) -> None:
    assert check_password(valid_password) is True


def test_check_password_invalid_too_short(invalid_password_too_short) -> None:
    assert check_password(invalid_password_too_short) is False


def test_check_password_invalid_too_long(invalid_password_too_long) -> None:
    assert check_password(invalid_password_too_long) is False


def test_check_password_invalid_no_digit(invalid_password_no_digit) -> None:
    assert check_password(invalid_password_no_digit) is False


def test_check_password_invalid_no_special_character(invalid_password_no_special_character) -> None:
    assert check_password(invalid_password_no_special_character) is False


def test_check_password_invalid_no_uppercase(invalid_password_no_uppercase) -> None:
