...
def test_not_latin_letter_should_be_not_approved():
    assert not check_password("ЫDimas96#")


def test_appropriate_passwords():
    assert check_password("Dimas96#")
...
def test_password_is_complete_with_not_allowed_symbols():
